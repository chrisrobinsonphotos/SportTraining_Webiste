...
const footerNav = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Adaptado', href: '/entrenamientos/adaptado' },
    ],
  },
  {
    title: 'Modalidades',
    links: [
      { label: 'Personal Training', href: '/modalidades/personal' },
      { label: 'Entrenamiento en Grupo', href: '/modalidades/grupo' },
      { label: 'Entrenamiento Libre', href: '/modalidades/libre' },
    ],
  },
  {
    title: 'Más',
