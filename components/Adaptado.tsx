...
export default function Adaptado() {
  ...
  return (
    <section ref={ref} className="relative bg-[#191919] min-h-screen flex overflow-hidden">
      ...
      {/* RIGHT: text — starts at right side, left-aligned within the panel */}
      <div className="relative z-10 ml-auto w-full lg:w-[58%] flex flex-col justify-center px-6 md:px-12 lg:px-16 py-24">
        ...
        <motion.p
          ...
          className="text-white/65 text-[17px] leading-relaxed mb-10 max-w-[460px]"
        >
          Aquí el entrenamiento va más allá del rendimiento. Es una herramienta para
          volver a sentirte fuerte, recuperar autonomía y reconectar con lo que tu cuerpo
          es capaz de hacer.
        </motion.p>
